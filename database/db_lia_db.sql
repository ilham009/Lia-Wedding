...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2020 at 03:46 PM
...
(1, 'Administrator', 'admin', '21232f297a57a5a743894a0e4a801fc3', '22112020085005d.jpg', '000000000 Bank BRI a/n ADMIN');
...
INSERT INTO `booking` (`id_booking`, `tgl_acara`, `nama_acara`, `tgl_booking`, `status`, `email`, `total_biaya`, `bukti_bayar`) VALUES
(44, '2020-12-01 21:42:00', 'sample2', '2020-11-23 21:43:02', 'Menunggu Pembayaran', 'z@z.com', 0, ''),
(45, '2020-11-24 21:45:00', 'asas', '2020-11-23 21:45:46', 'Menunggu Pembayaran', 'z@z.com', 0, '');
...
--
ALTER TABLE `booking`
  MODIFY `id_booking` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
